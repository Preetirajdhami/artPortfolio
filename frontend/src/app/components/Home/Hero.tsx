  ...
  return (
    <section className="bg-background h-screen flex items-center">
      <div className="w-full flex flex-col-reverse md:flex-row items-center">
        {/* Left Content */}
        <div className="md:w-1/2 px-4 md:px-6 lg:px-12 space-y-4 text-center md:text-left mt-6 md:mt-0">
          <button className="border bg-primary/25 px-4 rounded-full">Art</button>
          <h1 className="text-4xl md:text-5xl font-serif leading-tight text-gray-900">
            Unveil Your Vision: <br />
            Embrace Creation, <br />
            Embrace You
          </h1>
          <p>An artist exploring beauty through graphite, watercolor, acrylic, and pastel. Let my art speak where words fall short. </p>
          <a
            href="/schedule"
